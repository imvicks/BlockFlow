...
SECRET_KEY = 'django-insecure-==s%=@z!yi6db$dy&@77b14r!)fo*%t884rva5!5l3g$815e-@'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Collect static in production
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Media storage in production
